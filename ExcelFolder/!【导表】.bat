...
"C:\Program Files\Python 3.13.0\python.exe" ..\ExcelExportTool\export_all.py %input_folder% %output_project_folder% %output_client_folder% %csfile_output_folder% %enum_output_folder%
pause
